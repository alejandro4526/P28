...
// Variables para guardar los estados de los LEDs
	...
	// Reconocimiento de voz
            ...
            recognition.onresult = (event) => {
                ...
                if (command.includes('prender el ventilador')) {
                    client.publish('test/ventilador', 'on', { qos: 2, retain: true });
                    alert('Ventilador encendido');
                } else if (command.includes('apagar el ventilador')) {
                    client.publish('test/ventilador', 'off', { qos: 2, retain: true });
